...
Below are some notes on how to build Stone Core for Windows.
...
way. This will install to `c:\workspace\stone`, for example:

    make install DESTDIR=/mnt/c/workspace/stone
