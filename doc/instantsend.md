...
This mechanism has been integrated into Bitcore-Node-stone which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/stone-project/insight-api-stone#web-socket-api](https://github.com/stone-project/insight-api-stone#web-socket-api)
* API: [https://github.com/stone-project/insight-api-stone#instantsend-transactions](https://github.com/stone-project/insight-api-stone#instantsend-transactions)
