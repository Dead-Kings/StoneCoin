...
When deployed on testnet, it is required to start with a fresh data directory or call Stone Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/stone-project/stone/compare/v0.12.3.3...stone-project:v0.12.3.4).
