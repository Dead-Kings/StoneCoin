...
- [`595826ad6`](https://github.com/stone-project/stone/commit/595826ad6) Merge #12549: Make prevector::resize() and other prevector operations much faster
...
- [`2e980018c`](https://github.com/stone-project/stone/commit/2e980018c) Merge #11568: Disconnect outbound peers on invalid chains
...
- [`a88e000fe`](https://github.com/stone-project/stone/commit/a88e000fe) Merge #11247: qt: Use IsMine to validate custom change address
...
- [`f51a4df5c`](https://github.com/stone-project/stone/commit/f51a4df5c) Allow calling add_nodes multiple times without reusing datadirs
...
- [`e941c9ba5`](https://github.com/stone-project/stone/commit/e941c9ba5) Merge #11028: Avoid masking of difficulty adjustment errors by checkpoints
...
- [`6dce8d273`](https://github.com/stone-project/stone/commit/6dce8d273) Fix includes
...
- [`c9784838a`](https://github.com/stone-project/stone/commit/c9784838a) Merge #10589: More economical fee estimates for RBF and RPC options to control
...
- [`9d206814c`](https://github.com/stone-project/stone/commit/9d206814c) Merge #10783: [RPC] Various rpc argument fixes
...
- [`b430366dd`](https://github.com/stone-project/stone/commit/b430366dd) Merge #10199: Better fee estimates
...
- [`2b9216e98`](https://github.com/stone-project/stone/commit/2b9216e98) /s/BTC/stone
...
- [`b71a187da`](https://github.com/stone-project/stone/commit/b71a187da) Backport yet another part of 11824
...
- [`722c373f5`](https://github.com/stone-project/stone/commit/722c373f5) bitcoin -> stone
...
- [`80b803250`](https://github.com/stone-project/stone/commit/80b803250) Merge #10561: Remove duplicate includes
...
- [`e7d7ecb6e`](https://github.com/stone-project/stone/commit/e7d7ecb6e) Set a few param values to 0 by default
...
- [`de9629553`](https://github.com/stone-project/stone/commit/de9629553) Merge #9614: [wallet] [refactor] Simplify getbalance implementation
...
- [`c44dece48`](https://github.com/stone-project/stone/commit/c44dece48) Disable DIP3 in multiple tests
...
- [`80f8bb17d`](https://github.com/stone-project/stone/commit/80f8bb17d) Merge #9966: Control mempool persistence using a command line parameter
...
- [`1dec8e693`](https://github.com/stone-project/stone/commit/1dec8e693) Merge #10278: [test] Add Unit Test for GetListenPort
...
- [`8df25bbfe`](https://github.com/stone-project/stone/commit/8df25bbfe) Call and implemente new signals in CPrivateSend
...
- [`7fd979cc0`](https://github.com/stone-project/stone/commit/7fd979cc0) Merge #10114: [tests] sync_with_ping should assert that ping hasn't timed out
...
- [`7edb9e15a`](https://github.com/stone-project/stone/commit/7edb9e15a) Merge #10017: combine_logs.py - aggregates log files from multiple bitcoinds during functional tests.
- [`f2e976a05`](https://github.com/stone-project/stone/commit/f2e976a05) Merge #10045: [trivial] Fix typos in comments
- [`2c833eff3`](https://github.com/stone-project/stone/commit/2c833eff3) Merge #10039: Fix compile errors with Qt 5.3.2 and Boost 1.55.0
- [`a6eee07f2`](https://github.com/stone-project/stone/commit/a6eee07f2) Merge bitcoin#9963: util: Properly handle errors during log message formatting (#2917)
- [`67c735b15`](https://github.com/stone-project/stone/commit/67c735b15) s/bitcoin-config.h/stone-config.h/
- [`2f63322cd`](https://github.com/stone-project/stone/commit/2f63322cd) stoneify "Finding reviewers" section to be more relevant
- [`e7a21faa2`](https://github.com/stone-project/stone/commit/e7a21faa2) Merge Bitcoin#9960: Trivial: Add const modifier to GetHDChain and IsHDEnabled
- [`eecc72436`](https://github.com/stone-project/stone/commit/eecc72436) Merge #10564: Return early in IsBanned.
- [`742744f25`](https://github.com/stone-project/stone/commit/742744f25) Merge #10522: [wallet] Remove unused variables
- [`31bb4622a`](https://github.com/stone-project/stone/commit/31bb4622a) Merge #10538: [trivial] Fix typo: "occurrences" (misspelled as "occurrances")
- [`f57063155`](https://github.com/stone-project/stone/commit/f57063155) Merge #10514: Bugfix: missing == 0 after randrange
- [`b708ea819`](https://github.com/stone-project/stone/commit/b708ea819) Merge #10469: Fixing typo in rpcdump.cpp
- [`55dc3dae5`](https://github.com/stone-project/stone/commit/55dc3dae5) Merge #10486: devtools: Retry after signing fails in github-merge
- [`0d2f2b361`](https://github.com/stone-project/stone/commit/0d2f2b361) Merge #10273: [scripts] Minor improvements to `macdeployqtplus` script.
- [`317b797e2`](https://github.com/stone-project/stone/commit/317b797e2) Merge #9670: contrib: github-merge improvements
- [`a3467dd26`](https://github.com/stone-project/stone/commit/a3467dd26) Merge #10228: build: regenerate bitcoin-config.h as necessary
- [`a089c9325`](https://github.com/stone-project/stone/commit/a089c9325) Merge #9827: Improve ScanForWalletTransactions return value
- [`383d1819a`](https://github.com/stone-project/stone/commit/383d1819a) Merge #10211: [doc] Contributor fixes & new "finding reviewers" section
- [`632956a80`](https://github.com/stone-project/stone/commit/632956a80) Merge #9693: Prevent integer overflow in ReadVarInt.
- [`0db1328a2`](https://github.com/stone-project/stone/commit/0db1328a2) Merge #10177: Changed "Send" button default status from true to false
- [`dccd6970b`](https://github.com/stone-project/stone/commit/dccd6970b) Merge #10164: Wallet: reduce excess logic InMempool()
- [`23530a88a`](https://github.com/stone-project/stone/commit/23530a88a) Merge #10135: [p2p] Send the correct error code in reject messages
- [`e5ecff6e8`](https://github.com/stone-project/stone/commit/e5ecff6e8) Merge #9949: [bench] Avoid function call arguments which are pointers to uninitialized values
- [`3dcaf4749`](https://github.com/stone-project/stone/commit/3dcaf4749) Merge #10166: Ignore Doxyfile generated from Doxyfile.in template.
- [`13cdff498`](https://github.com/stone-project/stone/commit/13cdff498) Merge #10104: linearize script: Option to use RPC cookie
- [`f471b75ae`](https://github.com/stone-project/stone/commit/f471b75ae) Merge #9533: Allow non-power-of-2 signature cache sizes
- [`198808894`](https://github.com/stone-project/stone/commit/198808894) Merge #10058: No need to use OpenSSL malloc/free
- [`22b21f50c`](https://github.com/stone-project/stone/commit/22b21f50c) Merge #10077: [qa] Add setnetworkactive smoke test
- [`9fa51cc66`](https://github.com/stone-project/stone/commit/9fa51cc66) Merge #10072: Remove sources of unreliablility in extended functional tests
- [`818ec218d`](https://github.com/stone-project/stone/commit/818ec218d) Merge #10128: Speed Up CuckooCache tests
- [`07ed44df6`](https://github.com/stone-project/stone/commit/07ed44df6) Merge #10136: build: Disable Wshadow warning
- [`b5968cd7a`](https://github.com/stone-project/stone/commit/b5968cd7a) Merge #10129: scheduler: fix sub-second precision with boost < 1.50
- [`16641e1b1`](https://github.com/stone-project/stone/commit/16641e1b1) Merge #10095: refactor: Move GetDifficulty out of `rpc/server.h`
- [`6edbc9ceb`](https://github.com/stone-project/stone/commit/6edbc9ceb) Merge bitcoin#9956: Reorganise qa directory (#2912)
- [`ace96a941`](https://github.com/stone-project/stone/commit/ace96a941) Drop xvfb and run tests in linux64_nowallet
- [`fc1b3772d`](https://github.com/stone-project/stone/commit/fc1b3772d) Merge #10899: [test] Qt: Use `_putenv_s` instead of setenv on Windows builds
- [`f8c3f9f7d`](https://github.com/stone-project/stone/commit/f8c3f9f7d) Merge #10142: Run bitcoin_test-qt under minimal QPA platform
- [`826846f15`](https://github.com/stone-project/stone/commit/826846f15) Review suggestions
- [`9cef545ac`](https://github.com/stone-project/stone/commit/9cef545ac) code review
- [`720f13d69`](https://github.com/stone-project/stone/commit/720f13d69) add a comment linking to xvfb documentation
- [`5f4519804`](https://github.com/stone-project/stone/commit/5f4519804) Merge #9734: Add updating of chainTxData to release process
- [`1914c2d78`](https://github.com/stone-project/stone/commit/1914c2d78) Merge #10038: Add mallocinfo mode to `getmemoryinfo` RPC
- [`de0919220`](https://github.com/stone-project/stone/commit/de0919220) Merge #10027: Set to nullptr after delete
- [`d56322285`](https://github.com/stone-project/stone/commit/d56322285) Merge #10033: Trivial: Fix typo in key.h comment
- [`22563f369`](https://github.com/stone-project/stone/commit/22563f369) Merge #10024: [trivial] Use log.info() instead of print() in remaining functional test cases.
- [`dd91bd7b3`](https://github.com/stone-project/stone/commit/dd91bd7b3) Merge #9911: Wshadow: various gcc fixes
- [`eea802738`](https://github.com/stone-project/stone/commit/eea802738) Merge #9987: Remove unused code
- [`6376da03f`](https://github.com/stone-project/stone/commit/6376da03f) Merge #9818: Save watch only key timestamps when reimporting keys
- [`8e0968faf`](https://github.com/stone-project/stone/commit/8e0968faf) Merge #9690: Change 'Clear' button string to 'Reset'
- [`aee4472ac`](https://github.com/stone-project/stone/commit/aee4472ac) Merge #9974: Add basic Qt wallet test
- [`ae9ca8459`](https://github.com/stone-project/stone/commit/ae9ca8459) Merge #10010: util: rename variable to avoid shadowing
- [`594b78fdf`](https://github.com/stone-project/stone/commit/594b78fdf) Merge #9921: build: Probe MSG_DONTWAIT in the same way as MSG_NOSIGNAL
- [`5ae202da9`](https://github.com/stone-project/stone/commit/5ae202da9) Merge #9842: Fix RPC failure testing (continuation of #9707)
- [`1cfda206a`](https://github.com/stone-project/stone/commit/1cfda206a) Merge #9993: Initialize nRelockTime
