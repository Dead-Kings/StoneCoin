...
Gitian is the deterministic build process that is used to build the stone
...
git clone https://github.com/stone-project/stone
...
in the Stone Core repository under 'Fetch and create inputs' to install sources which require
...
```bash
    ...
    From https://github.com/stone-project/stone
...
BTCPATH=/some/root/path/stone
SIGPATH=/some/root/path/stone-detached-sigs
...
[stone/gitian.sigs](https://github.com/stone-project/gitian.sigs/) repository, or if that's not possible to create a pull
request.
