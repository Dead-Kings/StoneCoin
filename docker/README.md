...
official/supported Docker Images found at https://hub.docker.com/r/stone-project/stoned/
...
**NOTE: Please update the image description at https://hub.docker.com/r/stone-project/stoned-develop/ when changing the above text**
