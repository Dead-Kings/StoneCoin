...
{
    const char* pszTimestamp = "StoneMain";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 1 * 60; // Stone: 1 hour
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Stone: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // Stone: 2.5 minutes
...
*/
        ...
        // Testnet Stone BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CDevNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("stoneevo.org",  "devnet-seed.stoneevo.org"));

        // Testnet Stone addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Stone script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Stone BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Stone BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
...
public:
    CRegTestParams() {
        ...
        // Regtest Stone addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Stone script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Stone BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Stone BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Stone BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
