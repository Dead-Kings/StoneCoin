// Copyright (c) 2018-2019 The Stone Core developers
// Distributed under the MIT/X11 software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef stone_CRYPTO_BLS_BATCHVERIFIER_H
#define stone_CRYPTO_BLS_BATCHVERIFIER_H
...
#endif //stone_CRYPTO_BLS_BATCHVERIFIER_H
