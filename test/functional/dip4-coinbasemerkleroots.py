#!/usr/bin/env python3
# Copyright (c) 2015-2021 The Stone Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
from collections import namedtuple

from test_framework.mininode import *
from test_framework.test_framework import stoneTestFramework
...
class LLMQCoinbaseCommitmentsTest(stoneTestFramework):
    def set_test_params(self):
        self.set_stone_test_params(6, 5, fast_dip3_enforcement=True)
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as stoneTestFramework doesn't support this atm)
