# Contents
This directory contains tools to automatically get data about the memory consumption by some objects in stoned process with the help of GDB debugger.

## stone_dbg.sh
This shell script attaches GDB to the running stoned process (should be built with debug info), executes debug.gdb script and detaches.
By default it uses testnet settings, see script comments to attach it to mainnet stoned.
