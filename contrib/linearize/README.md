# Linearize
Construct a linear, no-fork, best version of the stone blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install stone_hash

https://github.com/stone-project/stone_hash
...
JSON-RPC server. Running `stoned` or `stone-qt -server` will be sufficient.
...
* `input`: stoned blocks/ directory containing blkNNNNN.dat
